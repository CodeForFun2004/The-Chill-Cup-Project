...
//   decreaseQuantity,
//   clearCart,
//   applyDiscount, // Import applyDiscount thunk
//   removeAppliedPromotionCode, // Import removeAppliedPromotionCode action
...
//     dispatch(applyDiscount({ promotionCode: code })); // Truyền object với key promotionCode
//   };

//   const handleRemovePromoCode = () => {
//     dispatch(removeAppliedPromotionCode()); // Gọi action để xóa mã khuyến mãi khỏi state
//     // ✅ QUAN TRỌNG: Để đồng bộ hoàn toàn, bạn cần một API call để xóa mã giảm giá ở backend
//     // và nhận về giỏ hàng cập nhật. Hiện tại, đây chỉ là cập nhật UI cục bộ.
//   };
